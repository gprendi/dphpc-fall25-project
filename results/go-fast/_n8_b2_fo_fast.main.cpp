        ...
        {
            {
                ...
                out_ptr0[static_cast<int64_t>(0LL)] = tmp6;
            }
        }
    }
    {
...
static PyObject* kernel_py(PyObject* self, PyObject* args) {
    try {
        ...
        kernel(parse_arg<double*>(args, 0), parse_arg<double*>(args, 1), parse_arg<double*>(args, 2), parse_arg<double*>(args, 3), parse_arg<double*>(args, 4)); Py_RETURN_NONE;
